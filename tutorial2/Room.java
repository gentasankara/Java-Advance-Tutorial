...
public class Room {
   private String name;
    ...
    public void setDimension(Dimension[] inDimension) {
         this.arrayDimension = inDimension;
     }

     public void setWindow(Window[] inWindow) {
         this.arrayWindow = inWindow;
     }
    ...
    {
        return "Room " + this.getName() + " with " + this.getDimension()+ " (in m), with " + this.getWindow()
